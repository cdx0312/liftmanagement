...
/**
 * MyAioHandler 实现AioHandler接口的方法
 * 完成编码和解码
 */
public abstract class MyAioHandler implements AioHandler {
	/**
	 ...
	 * @return MyPacket 返回解码之后的showcasePacket
